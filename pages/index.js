...
export default function Home() {
  ...
  function handleSubmit(e){ 
    ...
    if(nome.length === 0 || telefone.length === 0 || email.length === 0 || projeto.length === 0){
      setError('Preencha todos os campos')
      setCor(true)

    }else if(nome.length > 0 || telefone.length > 0 || email.length > 0 || projeto.length > 0){
      ...
      fetch('/api/contact', {
        ...
        if (res.status === 200) {
          ...
          setProjeto('')
          setCor(false)
          setError('Parabens! o primeiro passo foi dado, em breve entro em contato com você')
    
        }
      }).catch((error)=>{
        if(res.status === 500){
          res.status(500).send(error)
          setError('Desculpe, o servidor está fora do ar')
        }
      })
  ...
  return (
    <div>
      <Head>
      <meta name="description" content="Meu nome é Valdisnei Nilo, trabalho com desenvolvimento de sites e sistemas web transformo ideias em resultados através de linhas de código.Sou de Araguaina-Tocantins"/>
      <meta property="og:type" content="website"/>
      <meta property="og:title" content="Valdisnei Nilo || Desenvolvedor Full Stack"/>
      <meta property="og:description" content="Meu nome é Valdisnei Nilo, trabalho com desenvolvimento de sites e sistemas web transformo ideias em resultados através de linhas de código. Sou de Araguaina-Tocantins "/>
      <meta property="og:url" content="https://valdev.com.br"/>
      <meta property="og:image" content="https://valdev.com.br/public/og-image.png"/>
      ...
      <main className={styles.main}>
        ...
        <header className={styles.header}>
          <ul>
            ...
            <li href="#faq" onClick={handleClick}>FAQ</li>
        ...
        <section className={styles.home}>
          ...
          <div className={styles.chamadaContato} >
            <p>👋 Olá, sou responsável por dar vida ao seu projeto. Quer saber como? Clique no botão abaixo. 🙋</p>
            <button><a href="https://api.whatsapp.com/send?phone=5563991030921&text=Bom%20dia%20gostaria%20de%20falar%20sobre%20o%20desenvolvimento%20de%20um%20projeto" target="_blank" rel="noreferrer">Fale comigo 👋🏻</a></button>
          </div>
          ...
          <div className={styles.quemSou} id="chamadaContato">
            <div className={styles.quemSouTexto}>
              ...
              <div className={styles.redes}>
                ...
                <div>
                  <a href="https://www.linkedin.com/in/valdisnei-nilo-656b67202/"  target="_blank" rel="noreferrer">
                    <Image
                      src="/linkedin.png"
                      alt="Picture of the author"
                      width={20}
                ...
                <div>
                  <a href='https://github.com/valdisneinilo' target='_blank' rel="noreferrer">
                    <Image
                      src="/github.png"
                      alt="Picture of the author"
                      width={20}
            ...
            <div className={styles.containerProj}>
              ...
              <div  className={styles.ProjetosCont}>
                ...
                <div className={styles.textoProjeto}>
                  ...
                  <a  href="#" target="_blank" rel="noreferrer">Acessar site <Image src="/Arrow.svg"  alt="Picture of the author" width={50} height={10}/></a>
                </div>
              </div>
      ...
      <section className={styles.formCont} id="contato">
        ...
        <div className={styles.containerformulario}>
          <div className={styles.duvida}>
            ...
            <form action="" method="POST" className={styles.formulario} autoComplete="none">
              <input 
                type="text"  
                id="nome" 
                placeholder="Nome" 
              ...
              {error &&  <p style={ cor ? { color:'red'} : {color:'yellowgreen'}}>{error}</p>}

              {/* span */}
              <label className={styles.nao}>Se vc não  é um robô, deixe em brancos</label>
              <input type="text" className={styles.nao} name="leaveblank" />
              <label className={styles.nao}>Se vc não  é um robô, deixe em brancos</label>
              <input type="text" className={styles.nao} id="dontchang" name="dontchang"/>
              {/* span */}

              < button onClick = {(e) => {handleSubmit (e)}}>Iniciar Projeto</button>
